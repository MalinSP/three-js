...
// // Tip 10
// Better to do without lights for performance or use cheap light Ambient, directional and hemisphere
...
// const geometries = []
// for (let i = 0; i < 50; i++) {
//   const geometry = new THREE.BoxGeometry(0.5, 0.5, 0.5) // move from cycle
...
// // Tip 19
//     const geometry = new THREE.BoxGeometry(0.5, 0.5, 0.5) move from cycle
//     const material = new THREE.MeshNormalMaterial() move from cycle
// for(let i = 0; i < 50; i++)
// {
...
//     scene.add(mesh)
// }
// MeshStand or MeshPhysMaterial need more resources than materials such as BasicMaterial, LambertMater or PhongMaterial
...
const shaderMaterial = new THREE.ShaderMaterial({
  ...
  vertexShader: `
  // do calculation in vertex and send it to fragment
